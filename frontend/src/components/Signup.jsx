...
import AuthImagePattern from "./AutgImagePattern";
...
function Signup() {
  ...
  const validateForm = () => {
    ...
    if (formData.password.length < 6)
      return toast.error("Password must me atleast 6 ");
    return ture;
  };
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      <div className="flex flex-col justify-center items-center p-6 sm:p-12 ">
        <div className="w-full max-w-md space-y-8 p-10   bg-white/10 backdrop-blur-2xl  hover:bg-blue-300/20 transition-colors border border-white/20 rounded-box ">
          {/* Logo */}
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              <div className="size-12 rounded-xl bg-green-200/30 flex justify-center items-center group-hover:bg-primary/20 transition-colors">
                <MessagesSquare className="size-6 text-green-200" />
              </div>
